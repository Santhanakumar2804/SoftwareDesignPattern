...
const UserLeftbar = () => {
  ...
  return (
    <div className='absolute h-screen w-1/6 flex flex-col justify-between items-center bg-card text-card-foreground pt-10 shadow-lg border-r border-gray-300'>
